...
void selectMove(Player *attacker, Player *defender) {
    ...
    while (!validMove) {
        ...
        printf("\nEnter your move: ");
        scanf("%10s %3s", moveType, coordinate);
        ...
        char rowPart[3];                      // Temporary string for row parsing
        strncpy(rowPart, &coordinate[1], 2);  // Copy at most two digits (e.g., "10")
        rowPart[2] = '\0';                    // Ensure null termination
        x = atoi(rowPart) - 1; 
